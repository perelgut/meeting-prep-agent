...
Stephen Perelgut had that moment on a Monday afternoon, sitting at his computer in Etobicoke, in the west end of Toronto. He had spent two days — three working sessions in total — building a piece of software with the help of an AI assistant. Not vibe-coding a to-do list. Not asking ChatGPT to write an email. Building, from scratch, a working artificial intelligence agent: a program that could think through a problem, search the internet for relevant information, make judgments about what mattered, and produce a professional document ready for the boardroom.
...
He sounded slightly amazed. He is a fifty-year veteran of the computer industry — a man who worked at IBM alongside PhD researchers, who now teaches programming at a career college. He had seen a lot of technology. But this was different. And it had taken him two days.
...
The selection criteria were straightforward. The application needed a clear real-world use case. It needed to produce something tangible — not just text on a screen, but a document you could print and take into a room. It needed to be impressive enough to demonstrate. And it needed to genuinely stretch the capabilities of AI, not just use it as a fancy search engine.

The Meeting Prep Agent checked every box.

It also, crucially, seemed like the kind of thing anyone could imagine wanting. You don't have to be a technologist to know the feeling of walking into a meeting underprepared. You don't have to be a programmer to imagine how useful it would be to have someone — or something — do that preparation for you.
...
It is a small thing, technically. It is a large thing, humanly. The difference between a tool that helps you and a tool that *knows* you is exactly this kind of nuance. And it was conceived, debated, and implemented in a single morning session.
...
All of it was designed, built, deployed, and tested across two days.
...
>
> Together, these three services cost nothing for a personal project and require no specialized expertise to set up. That, as you will see, is very much the point.
...
Users never see the technical ceiling. They see a system that handles itself gracefully. The fix took less than an afternoon.

The third surprise was the calendar.

The original plan was to connect the agent directly to Google Calendar through a new AI service. When that connection proved unavailable, the team pivoted. Instead of having the AI fetch the calendar data, they went directly to Google's own calendar service — bypassing the AI intermediary entirely.
...
Sometimes the workaround is the right answer. Two days in, that lesson is worth the whole project.
...
What it is, is real. A working application. Built by one person with no team, no budget, and no software engineering staff, in two days — across three sessions on a Monday and Tuesday in Etobicoke.
...
The thing Perelgut built in two days is real and it works. But the more important discovery is this: the experience of building it — of going from a blank page on a Monday morning to a live, working AI agent by Tuesday afternoon — is available to anyone who is willing to sit down and try.

You do not need to know how to code when you start. You need to know what you want to build and why it matters. The two-day workshop that Perelgut is now designing for his students is built on exactly that premise: that the distance between "I have an idea" and "I have a working AI agent" is, in 2026, measured not in months or credentials but in focused hours.

If you read about the dead man in the briefing and thought: *I would have caught that.* If you read about the private context field and thought: *I have meetings like that.* If you read about the calendar entries appearing and felt, for just a moment, the particular pleasure of a thing working the way it should —

You might be ready to build something of your own.
